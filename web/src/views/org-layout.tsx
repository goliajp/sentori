...
export function OrgLayout() {
  ...
  // v2.4 — bad slug → bounce to dashboard root (`/main`), not the
  // marketing landing at `/`.
  if (!currentOrg) return <Navigate replace to="/main" />
