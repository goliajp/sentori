    ...
    let out: Vec<Value> = rows
        ...
        .map(|r| {
            json!({
                ...
                "first_seen": r.get::<OffsetDateTime, _>("first_seen"),
                "last_seen": r.get::<OffsetDateTime, _>("last_seen"),
...
pub async fn get_trace(
    ...
    let spans: Vec<Value> = span_rows
        ...
        .map(|r| {
            json!({
                ...
                "status": r.get::<String, _>("status"),
                "started_at": r.get::<OffsetDateTime, _>("started_at"),
                "duration_ms": r.try_get::<i32, _>("duration_ms").unwrap_or(0),
    ...
    Ok(Json(json!({
        "trace": {
            ...
            "first_seen": trace_row.get::<OffsetDateTime, _>("first_seen"),
            "last_seen": trace_row.get::<OffsetDateTime, _>("last_seen"),
