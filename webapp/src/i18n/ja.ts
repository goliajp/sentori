...
export const ja: Messages = {
  ...
  "auth.signIn": "サインイン",
  "auth.signInFailed":
    "サインインに失敗しました — メールとパスワードを確認してください",
  ...
  "inbox.emptyHint":
    "処理するものはありません — イベントは issue としてここに集まります。",
  ...
  "instruments.prewarmedTip":
    "プリウォームのファントムサンプル。パーセンタイルから除外",
  ...
  "issue.impactUsers":
    "{users} 人のユーザー · 計 {events} 件(最大 {max} 件/人)",
  ...
  "issue.reopen": "再オープン",
  "issue.replayFrom":
    "{when}の発生時のリプレイです — 直近のイベントには付いていません。",
  "issue.replayNone":
  ...
  "notify.testFailed":
    "テストメールに失敗しました — SMTP 設定とサーバーログを確認してください。",
