...
export const en = {
  ...
  "instruments.prewarmedTip":
    "pre-warmed phantom samples, excluded from percentiles",
  ...
  "issue.reopen": "Reopen",
  "issue.replayFrom":
    "From the occurrence {when} — the newest event carried no replay.",
  "issue.replayNone":
  ...
  "notify.testFailed":
    "Test email failed — check the SMTP settings and server log.",
  ...
  "settings.deleteAdminConfirm":
    "Delete admin {email}? Their sessions end immediately.",
