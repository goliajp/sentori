...
export const en = {
  ...
  'inbox.emptyNoProject': 'Create a project, mint an ingest token, point the SDK at this instance.',
  ...
  'push.credentialSaved': '{provider} saved and verified.',
  ...
  'push.lastValidated': 'Validated {when} · {status}',
  ...
  'push.integrateScope': 'Requires a token with scope api. The one embedded in the app is scope ingest.',
  'push.integrateMint': 'Mint',
