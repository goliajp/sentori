...
export const en = {
  ...
  'push.configOptionalFcm': 'Optional for FCM — read from the service account',
  'push.secret': 'Secret (key / service account)',
  'push.secretPlaceholder': '-----BEGIN PRIVATE KEY----- …',
  'push.secretPlaceholderFcm': 'The whole service-account JSON from Firebase',
