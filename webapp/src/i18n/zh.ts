...
export const zh: Messages = {
  ...
  'push.config': '配置(JSON)',
  'push.configNotJson': '这不是合法的 JSON。',
  ...
  'push.neverValidated': '从未校验',
  'push.no': '否',
  'push.notAddressableHint': '注册时 sentori.user() 还没跑——只能收广播，无法从 issue 定向。',
  'push.configOptionalFcm': 'FCM 可留空 —— 从 service account 里读',
  'push.secret': '密钥(私钥 / service account)',
  'push.secretPlaceholder': '-----BEGIN PRIVATE KEY----- …',
  'push.secretPlaceholderFcm': 'Firebase 的整份 service account JSON',
  'push.provider': '厂商',
  'push.queued': '排队中',
  'push.reason': '原因',
  'push.retry': '重试',
