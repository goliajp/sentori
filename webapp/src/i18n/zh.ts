...
export const zh: Messages = {
  ...
  "inbox.emptyNoProject":
    "先在设置里创建项目、发一枚 ingest token,把 SDK 指向本实例。",
  ...
  "instruments.tracesEmpty":
    "还没有观察点 —— sentori.trace(name) 标记代码路径被走到。",
  ...
  "issue.guardAnchored":
    "已在 {release} 解决。只有该版本及更新版本的再现才会重新打开。",
  ...
  "notify.smtpUnconfigured":
    "SMTP 未配置 —— 设置 SENTORI_SMTP_HOST 后邮件通知生效。",
