...
//
// Push used to be a tab here and is now its own module. Four panels
// about whether last night's alert reached anyone do not belong
// behind the same door as "change my password".
