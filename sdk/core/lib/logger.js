    ...
    if (activeTransport !== null) {
        try {
            ...
            if (!transportThrewWarned) {
                ...
                try {
                    console.warn('[sentori/logger] setLogTransport callback threw; falling back to console for this line and onward', e);
                }
                catch {
...
function defaultConsoleEmit(level, tag, args) {
