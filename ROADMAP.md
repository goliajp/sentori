...
- **v2.1** 🚧 in-flight — Runtime metrics auto-instrument（FPS/heap/cold-start/route-nav/network）+ Endpoint health synthetic probe（outside-in cron, auto-issue on consecutive fail）。v2.0 close gate ✅ — W1 ready to start (autorun)。详见 [`docs/roadmap/v2.1.md`](./docs/roadmap/v2.1.md)。
