...
- **v0.7** ✅ 综合升级（已 ship + npm publish + git tag v0.7）：Phase 43 Linear/Slack 双向集成 + Phase 44 Sampling/数据分析 + Phase 45 Web SDK 矩阵（Vue/Svelte/Solid 三个新包） + Phase 46 Session-trail 轻量回放 + Phase 47 polish（Related issues / hover sync / perf bench / LCP gate / CHANGELOG）。8 个 npm 包：core@0.6.0、javascript@0.4.0、react@0.4.5、next@0.2.5、react-native@0.7.0、vue@0.1.0、svelte@0.1.0、solid@0.1.0
