...
- **Post-v2.2 master plan** 📝 draft — 跨 v2.3 / v2.4 / v2.5 的 8-phase 计划，按依赖排序（不按 ROI），承诺各 phase 内完整闭环不 defer。详见 [`docs/roadmap/post-v2.2-plan.md`](./docs/roadmap/post-v2.2-plan.md)；待 takagi sign-off 后从 Phase 0 起跑。
